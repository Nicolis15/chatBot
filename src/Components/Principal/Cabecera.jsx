...
export default function Cabecera(){
    return(
        <div class="flex items-center w-full p-5 border-b-2 border-gray-500">
            <div class=" flex felx-col gap-6 items-center w-1/2 ">
                <img src={logoImg} alt='Logo' class='w-15'/>
                <div>
                    <h1 class="font-code-bold text-4xl">
                        <a class="text-6xl text-blue-500">N</a>icolas
                        <a> </a>
                        <a a class="text-6xl text-blue-500">L</a>is 
                        <a> </a>
                        <a a class="text-6xl text-blue-500">C</a>ruz
                    </h1>
            ...
            <div class="flex gap-16 w-full pr-10 justify-end">
                <a href="https://nicolis15.github.io/webNicolas/" target="_blank" rel="noopener noreferrer">
                    <div className='flex flex-col items-center justify-center'>
                        <img src={logoPortafolio} alt='Logo' class='w-10'/>
                        <h1>My Portafolio</h1>
                    </div>
                </a>
                ...
                <a href="https://www.linkedin.com/in/nicolasliscruz/" target="_blank" rel="noopener noreferrer">
                    <div className='flex flex-col items-center justify-center'>
                        <img src={logoLinkedin} alt='Logo' class='w-10'/>
                        <h1>Linkedin</h1>
                    </div>
                </a>
                ...
                <a href="https://github.com/Nicolis15" target="_blank" rel="noopener noreferrer">
                    <div className='flex flex-col items-center justify-center'>
                        <img src={logogitHub} alt='Logo' class='w-10'/>
                        <h1>GitHub</h1>
                    </div>
                </a>
